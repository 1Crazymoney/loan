...
/// @title MapleLoan_2 implements a primitive loan with additional functionality, and is intended to be proxied.
contract MapleLoan_2 is IMapleLoan, Proxied, LoanPrimitive {
    ...
    // Using hacky function signature just to not need to change IMapleLoan Interface
    ...
    function acceptNewTerms(address[2] calldata assets_, uint256[13] calldata terms_) external override {
        ...
        (bool success, ) = refinancer.delegatecall("");
