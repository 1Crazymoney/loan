...
import { MockLoan } from "./mocks/MockLoan.sol";
...
contract LoanTest is DSTest {
    ...
    function test_story1() external {
        ...
        MockLoan loan = new MockLoan(address(borrower), assets, parameters, requests);
        ...
        assertEq(loan.drawableFunds(), 1_000_000, "Different available funds");
        ...
        assertEq(loan.drawableFunds(), 0, "Different available funds");
        ...
        assertEq(loan.drawableFunds(), 150_000, "Different available funds");
        ...
        assertTrue(lender.try_loan_claimFunds(address(loan), 714103, address(lender)), "Cannot remove collateral");
